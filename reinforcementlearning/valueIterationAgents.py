...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def computeQValueFromValues(self, state, action):
        ...
        for stateProbPair in list:
            ...
            QValue += prob * (self.mdp.getReward(state, action, sPrime) + (self.discount * self.values[sPrime] if sPrime in self.values and not self.mdp.isTerminal(sPrime) else 0))
